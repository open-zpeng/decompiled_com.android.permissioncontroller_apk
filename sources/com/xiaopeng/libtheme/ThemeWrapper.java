    ...
    private static void setViewResource(Context context, View view, String str, int i) {
        ...
        try {
            if (ThemeManager.AttributeSet.ALPHA.equals(str)) {
                ...
                Drawable drawable = ThemeContextCompat.getDrawable(applicationContext, i);
                getOverlayDrawable(drawable, view.getBackground());
                view.setBackground(drawable);
            } else if (ThemeManager.AttributeSet.FOREGROUND.equals(str)) {
                if (Build.VERSION.SDK_INT >= 23) {
                    Drawable drawable2 = ThemeContextCompat.getDrawable(applicationContext, i);
                    getOverlayDrawable(drawable2, view.getForeground());
                ...
                if (view instanceof ImageView) {
                    ...
                    Drawable drawable3 = ThemeContextCompat.getDrawable(applicationContext, i);
                    getOverlayDrawable(drawable3, imageView.getDrawable());
    ...
    private static void setCompoundDrawables(int i, android.widget.TextView textView, Drawable drawable) {
        ...
        if (i == 0 || i == 1 || i == 2 || i == 3) {
            ...
            if (compoundDrawables != null) {
                getOverlayDrawable(drawable, compoundDrawables[i]);
            ...
            if (compoundDrawablesRelative != null) {
                ...
                if (compoundDrawablesRelative != null) {
                    getOverlayDrawable(drawable, compoundDrawablesRelative[c]);
