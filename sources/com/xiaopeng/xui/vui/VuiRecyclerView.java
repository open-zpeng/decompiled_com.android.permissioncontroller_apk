        ...
        if (this.mIsVuiCanControlScroll) {
            ...
            try {
                ...
                if (this.mIsEnableInvisible && (layoutManager = getLayoutManager()) != null && (layoutManager instanceof LinearLayoutManager)) {
                    ...
                    int i2 = i + itemCount;
                    vuiProps.put("maxValue", i2);
                    vuiProps.put("displayStart", this.mIsReverse ? i2 - linearLayoutManager.findLastCompletelyVisibleItemPosition() : this.mStartPosition + linearLayoutManager.findFirstCompletelyVisibleItemPosition());
                    vuiProps.put("displayEnd", this.mIsReverse ? i2 - linearLayoutManager.findFirstCompletelyVisibleItemPosition() : this.mStartPosition + linearLayoutManager.findLastCompletelyVisibleItemPosition());
            ...
            if (getVuiAction().equals(VuiAction.SCROLLBYY.getName())) {
                vuiProps.put("canScrollUp", canScrollVertically);
                if (!canScrollVertically2 && !this.isVuiCanScrollDown) {
                    z = false;
                }
                vuiProps.put("canScrollDown", z);
            } else {
                vuiProps.put("canScrollLeft", canScrollHorizontally);
                if (!canScrollHorizontally2 && !this.isVuiCanScrollRight) {
                    z = false;
                }
                vuiProps.put("canScrollRight", z);
            }
