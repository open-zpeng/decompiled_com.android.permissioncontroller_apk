...
public class VuiFloatingLayerManager {
    ...
    public static void show(final View view, final int i, final int i2, final int i3, boolean z) {
        ...
        if (z) {
            XViewLocationUtils.scrollByLocation(view, new XViewLocationUtils.OnCorrectionLocationListener() { // from class: com.xiaopeng.xui.vui.floatinglayer.-$$Lambda$VuiFloatingLayerManager$UreOefirr9dgokSDF5X4eo6PEbY
