...
public class XShimmer {
    ...
    public static abstract class Builder<T extends Builder<T>> {
        ...
        public T setBaseAlpha(float f) {
            ...
            xShimmer.baseColor = (((int) (clamp(0.0f, 1.0f, f) * 255.0f)) << 24) | (xShimmer.baseColor & 16777215);
            return getThis();
        }

        public T setHighlightAlpha(float f) {
            XShimmer xShimmer = this.mShimmer;
            xShimmer.highlightColor = (((int) (clamp(0.0f, 1.0f, f) * 255.0f)) << 24) | (xShimmer.highlightColor & 16777215);
            return getThis();
        }
