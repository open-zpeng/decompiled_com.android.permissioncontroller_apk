...
public class XToggleDrawable extends Drawable {
    ...
    private void updateAttr(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        float dimension2 = obtainAttributes.getDimension(R$styleable.XToggleDrawable_toggle_light_radius, LIGHT_RADIUS_DEFAULT);
        int i = obtainAttributes.getInt(R$styleable.XToggleDrawable_toggle_brightness, 0);
        float f = obtainAttributes.getFloat(R$styleable.XToggleDrawable_toggle_light_strength, LIGHT_STRENGTH_DEFAULT);
        ...
        if (z) {
            ...
            this.mXLightPaint.setLightRadius(dimension2);
