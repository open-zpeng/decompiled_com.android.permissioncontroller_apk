...
import com.xiaopeng.xpui.R$attr;
...
public class XCircularProgressBar extends ProgressBar {
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        if (i2 == 0) {
            ProgressBar.mergeDrawableStates(onCreateDrawableState, STATE_PAUSED);
        } else if (i2 == 1) {
            ProgressBar.mergeDrawableStates(onCreateDrawableState, STATE_PLAYING_STOP);
        } else if (i2 == 2) {
            ProgressBar.mergeDrawableStates(onCreateDrawableState, STATE_PLAYING_PAUSE);
        } else if (i2 == 3) {
            ProgressBar.mergeDrawableStates(onCreateDrawableState, STATE_START_DOWNLOAD);
        }
