...
public class XTextToggle extends XToggleLayout {
    ...
    public XTextToggle(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (create != null && (xViewDelegate = this.mXViewDelegate) != null) {
            xViewDelegate.setFontScaleChangeCallback(new XViewDelegate.onFontScaleChangeCallback() { // from class: com.xiaopeng.xui.widget.toggle.-$$Lambda$XTextToggle$i_pFBXkvhpm2MTmIiwcFb8dK81E
