...
import com.xiaopeng.xpui.R$array;
...
public class XQuickSideBarView extends XView implements XViewDelegate.onFontScaleChangeCallback {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            if (xViewDelegate != null) {
                xViewDelegate.setFontScaleChangeCallback(new XViewDelegate.onFontScaleChangeCallback() { // from class: com.xiaopeng.xui.widget.quicksidebar.-$$Lambda$XQuickSideBarView$1ZB34fs1FOEgdHSSURf-ptiofIs
                    @Override // com.xiaopeng.xui.view.XViewDelegate.onFontScaleChangeCallback
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i < this.mLetters.size()) {
            ...
            canvas.drawText(this.mLetters.get(i), rectF.centerX(), rectF.centerY() + (((f4 - fontMetrics.top) / 2.0f) - f4), this.mPaint);
            this.mPaint.reset();
            i = i2;
        }
    }
