...
public class XTabLayout extends XLinearLayout implements IVuiElementListener {
    ...
    public XTabLayout(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (create != null && (xViewDelegate = this.mXViewDelegate) != null) {
            xViewDelegate.setFontScaleChangeCallback(new XViewDelegate.onFontScaleChangeCallback() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XTabLayout$Z8VnPCfc0CTRF4FLt1FkISn004c
                    ...
                    XTabLayout.this.moveIndicatorTo(true, new OnMoveIndicatorListener() { // from class: com.xiaopeng.xui.widget.XTabLayout.2.1.1
                        ...
                        public void onStart() {
                            if (XTabLayout.this.mOnTabChangeListener != null) {
                                ...
                                XTabLayout xTabLayout = XTabLayout.this;
                                onTabChangeListener.onTabChangeStart(xTabLayout, xTabLayout.mSelectTabIndex, z, false);
                            }
                        }
                        ...
                        public void onEnd() {
                            if (XTabLayout.this.mOnTabChangeListener != null) {
                                OnTabChangeListener onTabChangeListener = XTabLayout.this.mOnTabChangeListener;
                                XTabLayout xTabLayout = XTabLayout.this;
                                onTabChangeListener.onTabChangeEnd(xTabLayout, xTabLayout.mSelectTabIndex, z, false);
                            }
                        }
                    });
                }
    ...
    public void removeTab(int i, int i2) {
        ...
        boolean z = i2 == this.mSelectTabIndex;
        if (z) {
    ...
    public void removeTab(int i) {
        ...
        boolean z = this.mSelectTabIndex == i;
