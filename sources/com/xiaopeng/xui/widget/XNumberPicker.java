...
import com.xiaopeng.xpui.R$string;
...
public class XNumberPicker extends XLinearLayout {
    ...
    public XNumberPicker(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mSelectedTextSize = obtainStyledAttributes.getDimensionPixelSize(R$styleable.XNumberPicker_np_selectedTextSize, 20);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i4 = 0; i4 < iArr.length; i4++) {
            ...
            if (z) {
                if (i4 == 2) {
                    this.mSelectorWheelPaint.setColor(this.mTextColors.getColorForState(LinearLayout.SELECTED_STATE_SET, -16777216));
    ...
    private void fling(int i) {
        this.mPreviousScrollerY = 0;
        if (i > 0) {
            this.mFlingScroller.fling(0, 0, 0, i, 0, 0, 0, Preference.DEFAULT_ORDER);
        } else {
            this.mFlingScroller.fling(0, Preference.DEFAULT_ORDER, 0, i, 0, 0, 0, Preference.DEFAULT_ORDER);
        }
        invalidate();
    }
