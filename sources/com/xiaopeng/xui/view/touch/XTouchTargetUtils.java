...
public class XTouchTargetUtils {
            ...
            public void run() {
                if (view.isAttachedToWindow()) {
                    ...
                    if (XTouchTargetUtils.HIT_RECT.width() == 0 || XTouchTargetUtils.HIT_RECT.height() == 0) {
                        XTouchTargetUtils.access$000(" width or height == 0 " + hashCode());
                ...
                XTouchTargetUtils.access$000("not isAttachedToWindow " + hashCode());
            }
        });
    }
    ...
    private static class LayoutAttachStateChangeListener implements View.OnLayoutChangeListener, View.OnAttachStateChangeListener {
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            XTouchTargetUtils.access$000(" LayoutAttachStateChangeListener  onLayoutChange ");
        }
        ...
        public void onViewDetachedFromWindow(View view) {
            view.removeOnLayoutChangeListener(this);
            view.removeOnAttachStateChangeListener(this);
            XTouchTargetUtils.access$000(" LayoutAttachStateChangeListener  onViewDetachedFromWindow ");
        }
    }
    ...
    public static void extendTouchAreaAsParentSameSize(final View view, final ViewGroup viewGroup) {
        ...
        view.post(new Runnable() { // from class: com.xiaopeng.xui.view.touch.XTouchTargetUtils.3
            ...
            public void run() {
                if (!view.isAttachedToWindow()) {
                    XTouchTargetUtils.access$000(" as not isAttachedToWindow " + hashCode());
                } else if (viewGroup.getWidth() == 0 || viewGroup.getHeight() == 0) {
                    XTouchTargetUtils.access$000(" as width or height == 0 " + hashCode());
    ...
    private static class LayoutAttachStateChangeListener2 implements View.OnLayoutChangeListener, View.OnAttachStateChangeListener {
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            view.removeOnLayoutChangeListener(this);
            view.removeOnAttachStateChangeListener(this);
            XTouchTargetUtils.access$000(" LayoutAttachStateChangeListener2  onLayoutChange ");
        }
        ...
        public void onViewDetachedFromWindow(View view) {
            view.removeOnLayoutChangeListener(this);
            view.removeOnAttachStateChangeListener(this);
            XTouchTargetUtils.access$000(" LayoutAttachStateChangeListener2  onViewDetachedFromWindow ");
        }
    }
    ...
    private static class MyStateChangeListener implements View.OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View view) {
            ...
            XTouchTargetUtils.access$000("  MyStateChangeListener onViewDetachedFromWindow " + view.hashCode());
